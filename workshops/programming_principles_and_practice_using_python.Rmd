...
- For those using `repl.it` a Python Shell is ready to use.
...
- String formatting - After variables section.
...
- Demo
  ...
  - Create a new file called `script1.py`
...
![python-functions](python-function.svg)
