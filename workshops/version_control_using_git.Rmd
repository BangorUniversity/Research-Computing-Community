...
---
# Command Line: Creating a Repository
...
# Command Line: Connect & Push to Github
...
---
#### Command Line: Clone From and Push To Github
...
# RStudio: Cloning from Github  
  ...
  - Notice that the new window opened has a 'Git' option on the top-right pane:
...
# RStudio: Push to Github
  ...
  - Our chnages have now been pushed up to the repository on Github. 
...
Conflicts exist when changes to a file in working copies occur concurrently and thus clash with the repository during commit/push.
