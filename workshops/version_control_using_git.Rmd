...
---
# Command Line: Creating a Local Repository
...
Once we have a working clone locally, we can push our chnages to GitHub by first *committing* them as above, and then *pushing* them:
